...
public class FrontendBuildFlow extends BasicBuildFlow {
    ...
    protected boolean preDockerBuild(String buildBasePath) throws IOException, MojoExecutionException {
        ...
        Files.move(Paths.get(Dew.Config.getCurrentProject().getMvnDirectory() + "dist"), Paths.get(buildBasePath + "dist"), StandardCopyOption.REPLACE_EXISTING);
        $.file.copyStreamToPath(Dew.class.getResourceAsStream("/dockerfile/frontend/Dockerfile"), buildBasePath + "Dockerfile");
        return true;
    }
