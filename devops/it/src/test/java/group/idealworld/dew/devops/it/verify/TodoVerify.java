...
public class TodoVerify extends BasicProcessor implements Verify {
    ...
    public void doVerify(String buildPath, String expectedResPath) throws Exception {
        ...
        // verify parent
        String metaData = $.http.get(itSnapshotRepositoryUrl + "group/idealworld/dew/devops/it/todo-parent/3.0.0-RC2/maven-metadata.xml");
        ...
        // verify common
        metaData = $.http.get(itSnapshotRepositoryUrl + "group/idealworld/dew/devops/it/todo-common/3.0.0-RC2/maven-metadata.xml");
