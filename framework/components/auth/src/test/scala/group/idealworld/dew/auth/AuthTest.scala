...
import group.idealworld.dew.Dew.Info
import group.idealworld.dew.auth.domain.{Ident, Resource}
import group.idealworld.dew.auth.dto.basic.{AccessTokenReq, AccessTokenResp}
import group.idealworld.dew.auth.dto.management.{AccountAddReq, AccountModifyReq, AccountResp, IdentAddReq, IdentModifyReq, IdentResp, ResourceAddReq, ResourceModifyReq, ResourceResp, RoleAddReq, RoleModifyReq, RoleResp, TenantAddReq, TenantModifyReq, TenantResp}
import group.idealworld.dew.auth.dto.user.{LoginReq, RegisterReq, UserModifyReq, UserResp}
import group.idealworld.dew.auth.sdk.TokenInfo
import group.idealworld.dew.auth.service.ManagementService
import group.idealworld.dew.test.DewTestAutoConfiguration
import group.idealworld.dew.Dew
import group.idealworld.dew.auth.domain.{Ident, Resource}
import group.idealworld.dew.auth.dto.basic.{AccessTokenReq, AccessTokenResp}
import group.idealworld.dew.auth.dto.management._
import group.idealworld.dew.auth.dto.user.{LoginReq, RegisterReq, UserModifyReq, UserResp}
import group.idealworld.dew.auth.sdk.TokenInfo
import group.idealworld.dew.auth.service.ManagementService
import group.idealworld.dew.test.DewTestAutoConfiguration
...
class AuthTest extends BasicTest {
  ...
  def testResource(tenantId: String): Int = {
    ...
    addReq.uri = "GET@/" + Info.name + "/test/auth/**"
    addReq.name = "测试权限"
