...
package group.idealworld.dew.auth.service

import com.ecfront.dew.common.{$, Page, Resp}
import com.typesafe.scalalogging.LazyLogging
import group.idealworld.dew.Dew
import group.idealworld.dew.auth.AuthConfig
import group.idealworld.dew.auth.domain.{Account, Ident, Resource, Role, Tenant}
...
import group.idealworld.dew.auth.repository.{AccountRepository, IdentRepository, ResourceRepository, RoleRepository, TenantRepository}
import group.idealworld.dew.Dew
import group.idealworld.dew.auth.AuthConfig
import group.idealworld.dew.auth.domain._
import group.idealworld.dew.auth.dto.management._
import group.idealworld.dew.auth.repository._
