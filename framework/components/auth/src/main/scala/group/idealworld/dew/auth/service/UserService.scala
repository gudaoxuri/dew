...
import group.idealworld.dew.auth.domain.{Account, Ident}
import group.idealworld.dew.auth.dto.user.{LoginReq, RegisterReq, SendVCReq, UserModifyReq, UserResp}
import group.idealworld.dew.auth.repository.{AccountRepository, IdentRepository}
import group.idealworld.dew.auth.sdk.TokenInfo
import group.idealworld.dew.core.auth.dto.OptInfo
import group.idealworld.dew.Dew
import group.idealworld.dew.auth.AuthConfig
import group.idealworld.dew.auth.domain.{Account, Ident}
import group.idealworld.dew.auth.dto.user._
import group.idealworld.dew.auth.repository.{AccountRepository, IdentRepository}
import group.idealworld.dew.auth.sdk.TokenInfo
import group.idealworld.dew.core.auth.dto.OptInfo
