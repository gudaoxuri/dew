...
public class AuthTest {
        ...
        public void testAll() {
                ...
                loginResult = Resp.generic(testRestTemplate.postForObject("/auth/login", loginDTO, Resp.class),
                                String.class);
                ...
                testRestTemplate.exchange("/auth/logout", HttpMethod.DELETE, new HttpEntity<>(null, headers),
                                Resp.class);
        ...
        private void testTokenKind(AuthController.LoginDTO loginDTO) {
                ...
                final String token1 = Resp.generic(
                                testRestTemplate.exchange("/auth/login",
                                                HttpMethod.POST, new HttpEntity<>(loginDTO, httpHeaders), Resp.class)
                                                .getBody(),
                ...
                Resp<OptInfoExt> bussinessResult = Resp.generic(
                                testRestTemplate.exchange("/auth/business/someopt",
                                                HttpMethod.GET, new HttpEntity<>(null, httpHeaders), Resp.class)
                                                .getBody(),
                                OptInfoExt.class);
