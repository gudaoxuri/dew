...
@SpringBootTest(classes = GatewayTest.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ComponentScan(basePackageClasses = {GatewayTest.class, Dew.class})
